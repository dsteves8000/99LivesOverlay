...
You may notice that the first line in the current overlay says "Time elapsed:___:__:__ (+LastTimeInSecondsYouPressedAnyUpdateButton)". I left the ":"'s in there so that the user could line up their current external stopwatch on their overlay with this overlay.
